...
m1_5 = sqldf("select proj, phase, count(phase) as perc from m1_1 group by proj,phase")

m2_1 = sqldf("select proj, phase from pom where month > 10 and month < 21")
m2_5 = sqldf("select proj, phase, count(phase) as perc from m2_1 group by proj,phase")

m3_1 = sqldf("select proj, phase from pom where month > 20 and month < 31")
m3_5 = sqldf("select proj, phase, count(phase) as perc from m3_1 group by proj,phase")

m4_1 = sqldf("select proj, phase from pom where month > 30 and month < 41")
m4_5 = sqldf("select proj, phase, count(phase) as perc from m4_1 group by proj,phase")

m5_1 = sqldf("select proj, phase from pom where month > 40 and month < 51")
m5_5 = sqldf("select proj, phase, count(phase) as perc from m5_1 group by proj,phase")

m6_1 = sqldf("select proj, phase from pom where month > 50 and month < 61")
m6_5 = sqldf("select proj, phase, count(phase) as perc from m6_1 group by proj,phase")

m7_1 = sqldf("select proj, phase from pom where month > 60 and month < 71")
m7_5 = sqldf("select proj, phase, count(phase) as perc from m7_1 group by proj,phase")

m8_1 = sqldf("select proj, phase from pom where month > 70 and month < 81")
m8_5 = sqldf("select proj, phase, count(phase) as perc from m8_1 group by proj,phase")

m9_1 = sqldf("select proj, phase from pom where month > 80 and month < 91")
m9_5 = sqldf("select proj, phase, count(phase) as perc from m9_1 group by proj,phase")

m10_1 = sqldf("select proj, phase from pom where month > 90 and month < 101")
m10_5 = sqldf("select proj, phase, count(phase) as perc from m10_1 group by proj,phase")
...
dev.off()
pdf('raw_test.pdf', width = 11, height = 8)
...
dev.off()
pdf('raw_packaging.pdf', width = 11, height = 8)
...
dev.off()
pdf('raw_install.pdf', width = 11, height = 8)
...
dev.off()
pdf('raw_deploy.pdf', width = 11, height = 8)

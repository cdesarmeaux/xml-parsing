...
library(scales)
pom = read.csv("rq.csv")
m1_1 = sqldf("select proj, name, phase from pom where month > 0 and month < 11")
m1_2 = sqldf("select proj, name, phase, count(phase) as count from m1_1 group by name,proj, phase")
m1_3 = sqldf("select proj, name, phase, count(phase) as sums from m1_1 group by name,proj")
m1_4 = sqldf("select m1_2.proj, m1_2.name, m1_2.phase, m1_2.count, m1_3.sums from m1_2, m1_3 where m1_2.proj = m1_3.proj and m1_2.name = m1_3.name")
m1_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m1_4")

m2_1 = sqldf("select proj, name, phase from pom where month > 10 and month < 21")
m2_2 = sqldf("select proj, name, phase, count(phase) as count from m2_1 group by name,proj, phase")
m2_3 = sqldf("select proj, name, phase, count(phase) as sums from m2_1 group by name,proj")
m2_4 = sqldf("select m2_2.proj, m2_2.name, m2_2.phase, m2_2.count, m2_3.sums from m2_2, m2_3 where m2_2.proj = m2_3.proj and m2_2.name = m2_3.name")
m2_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m2_4")

m3_1 = sqldf("select proj, name, phase from pom where month > 20 and month < 31")
m3_2 = sqldf("select proj, name, phase, count(phase) as count from m3_1 group by name,proj, phase")
m3_3 = sqldf("select proj, name, phase, count(phase) as sums from m3_1 group by name,proj")
m3_4 = sqldf("select m3_2.proj, m3_2.name, m3_2.phase, m3_2.count, m3_3.sums from m3_2, m3_3 where m3_2.proj = m3_3.proj and m3_2.name = m3_3.name")
m3_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m3_4")

m4_1 = sqldf("select proj, name, phase from pom where month > 30 and month < 41")
m4_2 = sqldf("select proj, name, phase, count(phase) as count from m4_1 group by name,proj, phase")
m4_3 = sqldf("select proj, name, phase, count(phase) as sums from m4_1 group by name,proj")
m4_4 = sqldf("select m4_2.proj, m4_2.name, m4_2.phase, m4_2.count, m4_3.sums from m4_2, m4_3 where m4_2.proj = m4_3.proj and m4_2.name = m4_3.name")
m4_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m4_4")

m5_1 = sqldf("select proj, name, phase from pom where month > 40 and month < 51")
m5_2 = sqldf("select proj, name, phase, count(phase) as count from m5_1 group by name,proj, phase")
m5_3 = sqldf("select proj, name, phase, count(phase) as sums from m5_1 group by name,proj")
m5_4 = sqldf("select m5_2.proj, m5_2.name, m5_2.phase, m5_2.count, m5_3.sums from m5_2, m5_3 where m5_2.proj = m5_3.proj and m5_2.name = m5_3.name")
m5_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m5_4")

m6_1 = sqldf("select proj, name, phase from pom where month > 50 and month < 61")
m6_2 = sqldf("select proj, name, phase, count(phase) as count from m6_1 group by name,proj, phase")
m6_3 = sqldf("select proj, name, phase, count(phase) as sums from m6_1 group by name,proj")
m6_4 = sqldf("select m6_2.proj, m6_2.name, m6_2.phase, m6_2.count, m6_3.sums from m6_2, m6_3 where m6_2.proj = m6_3.proj and m6_2.name = m6_3.name")
m6_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m6_4")

m7_1 = sqldf("select proj, name, phase from pom where month > 60 and month < 71")
m7_2 = sqldf("select proj, name, phase, count(phase) as count from m7_1 group by name,proj, phase")
m7_3 = sqldf("select proj, name, phase, count(phase) as sums from m7_1 group by name,proj")
m7_4 = sqldf("select m7_2.proj, m7_2.name, m7_2.phase, m7_2.count, m7_3.sums from m7_2, m7_3 where m7_2.proj = m7_3.proj and m7_2.name = m7_3.name")
m7_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m7_4")

m8_1 = sqldf("select proj, name, phase from pom where month > 70 and month < 81")
m8_2 = sqldf("select proj, name, phase, count(phase) as count from m8_1 group by name,proj, phase")
m8_3 = sqldf("select proj, name, phase, count(phase) as sums from m8_1 group by name,proj")
m8_4 = sqldf("select m8_2.proj, m8_2.name, m8_2.phase, m8_2.count, m8_3.sums from m8_2, m8_3 where m8_2.proj = m8_3.proj and m8_2.name = m8_3.name")
m8_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m8_4")

m9_1 = sqldf("select proj, name, phase from pom where month > 80 and month < 91")
m9_2 = sqldf("select proj, name, phase, count(phase) as count from m9_1 group by name,proj, phase")
m9_3 = sqldf("select proj, name, phase, count(phase) as sums from m9_1 group by name,proj")
m9_4 = sqldf("select m9_2.proj, m9_2.name, m9_2.phase, m9_2.count, m9_3.sums from m9_2, m9_3 where m9_2.proj = m9_3.proj and m9_2.name = m9_3.name")
m9_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m9_4")

m10_1 = sqldf("select proj, name, phase from pom where month > 90 and month < 101")
m10_2 = sqldf("select proj, name, phase, count(phase) as count from m10_1 group by name,proj, phase")
m10_3 = sqldf("select proj, name, phase, count(phase) as sums from m10_1 group by name,proj")
m10_4 = sqldf("select m10_2.proj, m10_2.name, m10_2.phase, m10_2.count, m10_3.sums from m10_2, m10_3 where m10_2.proj = m10_3.proj and m10_2.name = m10_3.name")
m10_5 = sqldf("select name, phase, (CAST(count AS float)/CAST(sums AS float)) as perc from m10_4")
